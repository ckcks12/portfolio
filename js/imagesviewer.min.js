...
!(function(i, e, t, n) {
    ...
    var v =
        '<div class="iv-loader"></div> <div class="iv-snap-view"><div class="iv-snap-image-wrap"><div class="iv-snap-handle"></div></div><div class="iv-zoom-slider"><div class="iv-zoom-handle"></div></div></div><div class="iv-image-view" ><div class="iv-image-wrap" ></div></div>'
    i(function() {
        m.length || (m = i('body')), m.append('<div id="iv-container">' + v + '<div class="iv-close"></div><div>')
    }),
        (s.prototype.init = function() {
            var i = this,
                e = (this.container, '.' + this.sliderId)
            return (
                this.container.on('touchstart' + e + ' mousedown' + e, function(t) {
                    t.preventDefault()
        ...
        (r.prototype = {
            ...
            _init: function() {
                            ...
                            if (!n) {
                                ...
                                f.onStart(),
                                    ...
                                    (a.slideMomentumCheck = setInterval(function() {
                                        a.currentPos &&
                                            (a.positions.shift(),
                                            a.positions.push({ x: a.currentPos.mx, y: a.currentPos.my }))
                                    }, 50))
                            }
                        },
                        onMove: function(i, e) {
                        ...
                        if (e.loaded) {
                            ...
                            if (t && a) {
                                ...
                                var s = o.offset(),
                                    ...
                                    h = e.zoomValue,
                                    m = { x: (a.pageX + t.pageX) / 2 - s.left, y: (a.pageY + t.pageY) / 2 - s.top },
                                    c = function(i) {
                                        i.preventDefault()
                                        var t = i.originalEvent.touches[0],
                ...
                v.on('click' + r, function(i) {
                    0 == M
                        ? ((M = Date.now()), (w = { x: i.pageX, y: i.pageY }))
                        : Date.now() - M < 500 && Math.abs(i.pageX - w.x) < 50 && Math.abs(i.pageY - w.y) < 50
                            ? (e.zoomValue == t.zoomValue ? e.zoom(200) : e.resetZoom(), (M = 0))
                            : (M = 0)
                })
                var z,
                    x,
                    y = e.snapView.find('.iv-zoom-slider')
                new s(y, {
                    sliderId: e._viewerId,
                    onStart: function(i) {
                        return e.loaded
                            ? ((this.leftOffset = y.offset().left),
                ...
                ;(D['mouseenter' + r + ' touchstart' + r] = function() {
                    ...
                    e.snapView.on(D),
                    t.refreshOnResize &&
                        c.on('resize' + r, function() {
                            e.refresh()
                        }),
                    e._fullPage &&
                        (o.on('touchmove' + r + ' mousewheel' + r + ' DOMMouseScroll' + r, function(i) {
                            i.preventDefault()
                        }),
            ...
            zoom: function(i, e) {
                function t() {
                    ...
                    ;(M = Math.min(M, u)),
                        ...
                        f > M + g && (M = f - g),
                        p > z + w && (z = p - w),
                        r.css({ height: w + 'px', width: g + 'px', left: M + 'px', top: z + 'px' }),
                        (n.zoomValue = h),
                ...
                ;(i = Math.round(Math.max(100, i))),
                    ...
                    (e = e || { x: this.containerDim.w / 2, y: this.containerDim.h / 2 })
                var n = this,
            ...
            _calculateDimensions: function() {
                ...
                var u = c > l ? h : (c * m) / l,
                    v = l > c ? m : (l * h) / c
                ;(i.snapImageDim = { w: u, h: v }),
                    i.snapImg.css({ width: u, height: v }),
            ...
            destroy: function(i, e) {
                ...
                return (
                    this._fullPage
                        ? (container.off(t), container.find('[class^="iv"]').off(t))
        ...
        (r.defaults = { zoomValue: 100, snapView: !0, maxZoom: 500, refreshOnResize: !0, zoomOnMouseWheel: !0 }),
        (e.ImageViewer = function(e, t) {
            var n, a, o
            ;(e && ('string' == typeof e || e instanceof Element || e[0] instanceof Element)) ||
                ((t = e), (e = i('#iv-container'))),
                (e = i(e)),
                e.is('img')
                    ? ((n = e),
                      (a = n[0].src),
                      ...
                      (e = n
                          .wrap('<div class="iv-container" style="display:inline-block; overflow:hidden"></div>')
                          .parent()),
                      n.css({ opacity: 0, position: 'relative', zIndex: -1 }))
